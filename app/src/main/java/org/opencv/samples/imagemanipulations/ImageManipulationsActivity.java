...
public class ImageManipulationsActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.RGBA)
            viewMode = VIEW_MODE_RGBA;
        if (item.getItemId() == R.id.Hist)
            viewMode = VIEW_MODE_HIST;
        else if (item.getItemId() == R.id.Canny)
            viewMode = VIEW_MODE_CANNY;
        else if (item.getItemId() == R.id.Sepia)
            viewMode = VIEW_MODE_SEPIA;
        else if (item.getItemId() == R.id.Sobel)
            viewMode = VIEW_MODE_SOBEL;
        else if (item.getItemId() == R.id.Zoom)
            viewMode = VIEW_MODE_ZOOM;
        else if (item.getItemId() == R.id.Pixelize)
            viewMode = VIEW_MODE_PIXELIZE;
        else if (item.getItemId() == R.id.Posterize)
